hrApp.controller('EmployeeListController', ['$scope', '$http', '$location', '$route', 'CommonResourcesFactoryBackup',
    function ($scope, $http, $location, $route, CommonResourcesFactoryBackup) {
